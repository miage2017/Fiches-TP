...
public class redormeur implements Runnable {
	String nom = null;
    Queue<Thread>  antecedents = new LinkedList<Thread>();

    public redormeur(String nom){
	this.nom = nom;
	...
	redormeur OC = new redormeur("Glandeur C");
	Thread TC = new Thread(OC, "Mister C");
	
	redormeur OB = new redormeur("Glandeur B");
	Thread TB = new Thread(OB, "Mister B");


	redormeur OA = new redormeur("Glandeur A");
